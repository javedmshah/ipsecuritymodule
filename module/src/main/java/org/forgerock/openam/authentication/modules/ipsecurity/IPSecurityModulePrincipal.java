 ...
 */
public class IPSecurityModulePrincipal implements Principal, Serializable {

    private static final long serialVersionUID = 1L;
	private String name;

    public IPSecurityModulePrincipal(String name) {
        if (name == null) {
    ...
    public String toString() {
        return new StringBuilder()
                .append(IPSecurityModulePrincipal.class.getName())
                .append(":")
                .append(name)
                .toString();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IPSecurityModulePrincipal)) {
            return false;
        }
        IPSecurityModulePrincipal that = (IPSecurityModulePrincipal) o;
